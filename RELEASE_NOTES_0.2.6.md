# Raspberry Pi 5 UEFI 0.2.6 [Soulveig Edition]

## English

### Changes since 0.2.4

- Updated the release compiler from Arm GNU Toolchain 15.2.Rel1 to 15.3.Rel1.
- Updated the host build environment from Python 3.9.6 to 3.14.7 and from GNU Make 3.81 to 4.4.1.
...
### Изменения относительно 0.2.4

- Релизный компилятор обновлён с Arm GNU Toolchain 15.2.Rel1 до 15.3.Rel1.
- Среда сборки обновлена с Python 3.9.6 до 3.14.7 и с GNU Make 3.81 до 4.4.1.
